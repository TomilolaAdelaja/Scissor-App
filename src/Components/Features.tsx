  ...
  return (
    <div className="grid grid-cols-[380px,repeat(2,_1fr)] gap-[64px] py-[105px] pb-[90px] px-[85px]" id='Features'>
        ...
        <div>
            ...
            <h4 className="text-2xl font-medium py-[14px]">URL Shortening</h4>
        ...
        <div>
            ...
            <h4 className="text-2xl font-medium py-[14px]">Custom URLs</h4>
        ...
        <div className="grid row-start-2 col-start-2 row-end-3 col-end-3">
            ...
            <h4 className="text-2xl font-medium py-[14px]">QR Codes</h4>
        ...
        <div className="grid row-start-2 col-start-3 row-end-3 col-end-4">
            ...
            <h4 className="text-2xl font-medium py-[14px]">Data Analytics</h4>
